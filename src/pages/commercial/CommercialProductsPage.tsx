  ...
  const loadAll = async () => {
    ...
    try {
      ...
      const [allProducts, allVariants, catRes, promoRes] = await Promise.all([
        fetchAllPages('products', 'id, name_ar, sku, stock, category_id, image_url, is_active_for_commercial, price_a, price_b, price_c, price_d, price_e', [{ col: 'is_active', val: true }]),
