...
BEGIN
    -- Liste de toutes les tables potentielles de l'application
    ...
    LOOP
        ...
        IF table_exists THEN
            ...
            IF rls_enabled THEN
                ...
                RAISE NOTICE '✅ RLS désactivé sur: %I', table_name;
            ELSE
                RAISE NOTICE 'ℹ️  RLS déjà désactivé sur: %I', table_name;
            END IF;
        ELSE
            RAISE NOTICE '⚠️  Table inexistante: %I', table_name;
        END IF;
    END LOOP;
